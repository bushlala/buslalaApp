        ...
        <View style={styles.screen}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{}}>
                <View style={{marginHorizontal:20,marginBottom:20}}>
                    ...
                    <View style={{elevation:5,width:"100%", backgroundColor:"white", borderRadius:10, padding:15}}>
                    ...
                    <View style={{marginTop:5,elevation:5,width:"100%", backgroundColor:"white", borderRadius:10, padding:25, justifyContent:"center",alignItems:"center"}}>
                    ...
                    <View style={{marginTop:20}}>
                        ...
                        <View style={{elevation:5,width:"100%", backgroundColor:"white", borderRadius:10, padding:15,marginVertical:5}}>
                        ...
                        <View style={{elevation:5,width:"100%", backgroundColor:"white", borderRadius:10, padding:15,marginBottom:5}}>
                            <View style={{flexDirection:"row",alignItems:"center",}}>
                                <View style={{}}>
