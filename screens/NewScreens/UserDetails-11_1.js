...
export default function UserDetails_11_1(){
    ...
    return(
        <View style={styles.screen}>
            ...
            <ScrollView style={{}} showsVerticalScrollIndicator={false}>
                ...
                <View style={{elevation:5,width:"100%", backgroundColor:"#fff", borderRadius:10,marginTop:-200,padding:10,alignItems:"center"}}>
                    <View style={{justifyContent:"space-between",flexDirection:"row",marginTop:10}}>
                        <View style={{alignItems:"center"}}>
                            <View style={{flexDirection:"row"}}>
                                <Text style={{color:"#000"}}>HYD</Text>
                                    <MaterialIcons name="sync-alt" color="#ed6c39" style={{alignSelf:"center",paddingHorizontal:10}} size={20} />
                                <Text style={{color:"#000"}}>MAS</Text>
                            </View>
                            <Text style={{color:"gray"}}>Selected seats</Text>
                            <Text style={{color:"#000",marginBottom:5}}>A4, B4</Text>
                            <Text style={{color:"gray"}}>Price</Text>
                            <Text style={{color:"#000"}}>₹2020</Text>
                        </View>
                        <View style={{borderColor:"#000",borderWidth:0.8,marginHorizontal:20}} />
                        <View style={{alignItems:"center"}}>
                            <View style={{flexDirection:"row"}}>
                                <Text style={{color:"#000"}}>HYD</Text>
                                    <MaterialIcons name="sync-alt" color="#ed6c39" style={{alignSelf:"center",paddingHorizontal:10}} size={20} />
                    ...
                    <TouchableOpacity style={{elevation:5, backgroundColor:"#ed6c39", borderRadius:10, padding:10,marginTop:10,alignItems:"center",paddingHorizontal:30,marginBottom:10}}>
