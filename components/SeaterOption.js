      ...
      .then(resp => {
        ...
        resp.data.bus.status == 'notstarted'
          ? navigation.navigate('SelectedScreen', {
              ...
              priceLowerSleeper: priceLowerSleeper,
              bus_model: bus_model,
              duration: duration,
              deptHour: deptHour,
    ...
    <TouchableOpacity
      ...
      <View style={styles.view1}>
        ...
        <View
          ...
          <FontAwesome
            ...
            color="black"
          />
          <Feather name="tv" size={18} color="black" />
        </View>
      ...
      <View style={styles.view2}>
        ...
        <View style={styles.hours}>
          <Text
            style={{fontFamily: RalewayRegular, fontSize: 13, color: 'black'}}>
            {deptHour}
          </Text>
          ...
          <Text style={{color: 'black'}}>─</Text>
          <Text
            style={{fontFamily: RalewayRegular, fontSize: 13, color: 'gray'}}>
            {arrivalHour}
          </Text>
        </View>
      </View>
